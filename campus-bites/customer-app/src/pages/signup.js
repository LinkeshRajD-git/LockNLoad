...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-[#E94E24]/20 rounded-full filter blur-3xl animate-float"></div>
      <div className="absolute bottom-20 right-10 w-72 h-72 bg-red-500/20 rounded-full filter blur-3xl animate-float" style={{animationDelay: '1s'}}></div>
      ...
      <div className="relative z-10 bg-gray-900/90 backdrop-blur-xl border border-gray-800 rounded-3xl shadow-2xl p-10 max-w-md w-full animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-black gradient-text mb-2">Join Us</h2>
          <p className="text-gray-400">Create your account to get started</p>
        </div>
        
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="relative">
            <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#E94E24]" size={20} />
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div className="relative">
            <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#E94E24]" size={20} />
            <input
              type="tel"
              name="phone"
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400">
            ...
            <Link href="/login" className="text-[#E94E24] font-bold hover:text-red-400 hover:underline transition-colors">
              Login here
            </Link>
          </p>
        </div>
